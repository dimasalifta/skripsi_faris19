...
def on_message(client, userdata, msg):
    ...
    labelS0.config(text="Nilai S0: " + str(s0) + " ppm")
    labelS1.config(text="Nilai S1: " + str(s1) + " ppm")
    labelS2.config(text="Nilai S2: " + str(s2) + " ppm")
    labelS3.config(text="Nilai S3: " + str(s3) + " ppm")
...
labelS0 = tk.Label(frameRGB, text="Nilai S0: ")
labelS1 = tk.Label(frameRGB, text="Nilai S1: ")
labelS2 = tk.Label(frameRGB, text="Nilai S2: ")
labelS3 = tk.Label(frameRGB, text="Nilai S3: ")
...
labelS0.pack(anchor=tk.NW)
labelS1.pack(anchor=tk.NW)
labelS2.pack(anchor=tk.NW)
labelS3.pack(anchor=tk.NW)
